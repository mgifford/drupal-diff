# Admin Theme (dark + light) People List - Form Label style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Component width is significantly wider: 190.6px vs 68.3px (+179.1%).
- Component height is significantly shorter: 17.8px vs 33.3px (-46.5%).
- Horizontal padding is significantly higher: 1.6px vs 1.1px (+40.0%).
- Matched element count is different: 2 fewer element(s) (-28.6%).
...
## Color Mode Coverage
- light: paddingX: 40.0% | width: 179.1% | height: -46.5% | count: -2 (-28.6%)
- dark: paddingX: 40.0% | width: 179.1% | height: -46.5% | count: -2 (-28.6%)
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/people-list__default__light__label.png
...
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/label[1]`
   ...
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/people-list__default__light__label.png
