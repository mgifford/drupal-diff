# Admin Theme (dark + light) Content Add Article - Toolbar Structure Toggle Button style regression vs Drupal 11 Gin
...
## Summary
Potential CSS regression in **Toolbar Structure Toggle Button** on **Content Add Article** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
...
## Evidence
- Baseline element screenshot: baseline/content-add-article__default__light__toolbar-structure-toggle.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/content-add-article__default__light__toolbar-structure-toggle.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[4]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/content-add-article__default__light__toolbar-structure-toggle.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/content-add-article__default__light__toolbar-structure-toggle.png
