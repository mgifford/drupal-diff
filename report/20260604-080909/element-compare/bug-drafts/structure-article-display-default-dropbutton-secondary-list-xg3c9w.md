# Admin Theme (dark + light) Structure Article Display - Dropbutton Secondary Actions List style regression vs Drupal 11 Gin
...
- Component height is significantly taller: 49.0px vs 0.0px (+100.0%).
...
## Summary
Potential CSS regression in **Dropbutton Secondary Actions List** on **Structure Article Display** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
...
- Candidate element screenshot: candidate/structure-content-type-article-display__default__light__dropbutton-secondary-list.png
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/structure-content-type-article-display__default__light__dropbutton-secondary-list.png
...
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/div[1]/div[2]/div[1]/table[1]/tbody[1]/tr[2]/td[3]/div[1]/div[1]/ul[1]/li[3]/ul[1]`
   - Text sample: Disable (RSS)
   - Related element screenshot: candidate/structure-content-type-article-display__default__light__dropbutton-secondary-list.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/structure-content-type-article-display__default__light__dropbutton-secondary-list.png
...
```html
<ul class="dropbutton__items" style="position: fixed; left: 1082.39px; right: auto; top: 528.797px;"> <li class="disable dropbutton__item dropbutton-action secondary-action"><a href="/admin/structure/types/manage/article/display/rss/disable?token=xoYO4qWeqgrCODsPKi42z1bPJv-AKt35ksbVPlFBB20">Disable <span class="visually-hidden">(RSS)</span></a></li> </ul>
```
