# Admin Theme (dark + light) Reports Updates - Details Summary style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Text size is significantly smaller: 0.0px vs 16.0px (-100.0%).
- Component width is significantly narrower: 0.0px vs 449.0px (-100.0%).
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/reports-updates__default__light__details-summary.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/div[2]/table[1]/tbody[1]/tr[1]/td[1]/div[3]/div[1]/div[3]/ul[1]/li[2]/details[1]/summary[1]`
   ...
   - Related element screenshot: baseline/reports-updates__default__light__details-summary.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/reports-updates__default__light__details-summary.png
