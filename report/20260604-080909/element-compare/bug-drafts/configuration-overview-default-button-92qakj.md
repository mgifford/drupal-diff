# Admin Theme (dark + light) Configuration Overview - Button style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Vertical padding is noticeably higher: 20.0px vs 18.0px (+11.1%).
- Horizontal padding is significantly higher: 27.5px vs 20.0px (+37.5%).
- Matched element count is different: 3 more element(s) (+60.0%).
- This same issue was also identified in dark mode.

## Summary
Potential CSS regression in **Button** on **Configuration Overview** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
Color mode coverage: **dark + light**

## Color Mode Coverage
- light: paddingY: 11.1% | paddingX: 37.5% | count: +3 (60.0%)
- dark: paddingY: 11.1% | paddingX: 37.5% | count: +3 (60.0%)

## Steps To Reproduce
1. Open baseline page: http://drupal-11.3.10.ddev.site/admin/config
2. Open candidate page: http://drupal-12.ddev.site/admin/config
...
## Evidence
- Baseline element screenshot: baseline/config-overview__default__light__button.png
- Candidate element screenshot: candidate/config-overview__default__light__button.png
- Baseline page screenshot: baseline-pages/config-overview__default__light__page.png
- Candidate page screenshot: candidate-pages/config-overview__default__light__page.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-overview__default__light__button.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/config-overview__default__light__button.png
- Baseline page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline-pages/config-overview__default__light__page.png
- Candidate page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate-pages/config-overview__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[2]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/config-overview__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-overview__default__light__button.png
   - Related page screenshot: baseline-pages/config-overview__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline-pages/config-overview__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[1]/div[2]/ul[1]/li[1]/button[1]`
   - Text sample: Extend Create
   - Related element screenshot: candidate/config-overview__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/config-overview__default__light__button.png
   - Related page screenshot: candidate-pages/config-overview__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate-pages/config-overview__default__light__page.png
