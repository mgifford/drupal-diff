# Admin Theme (dark + light) Configuration Basic HTML Format - Form Label style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Component width is significantly wider: 561.2px vs 165.2px (+239.8%).
- This same issue was also identified in dark mode.

## Summary
Potential CSS regression in **Form Label** on **Configuration Basic HTML Format** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
...
## Evidence
- Baseline element screenshot: baseline/config-text-format-basic-html__default__light__label.png
- Candidate element screenshot: candidate/config-text-format-basic-html__default__light__label.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-text-format-basic-html__default__light__label.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/config-text-format-basic-html__default__light__label.png
...
### Drupal 11 with Gin
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/form[1]/div[5]/div[1]/div[11]/label[1]`
   - Text sample: Lazy load images
   - Related element screenshot: baseline/config-text-format-basic-html__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-text-format-basic-html__default__light__label.png
...
```html
<label for="edit-filters-filter-image-lazy-load-status" class="form-item__label option">Lazy load images</label>
```

2. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/form[1]/div[6]/label[1]`
   - Text sample: Filter processing order
   - Related element screenshot: baseline/config-text-format-basic-html__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-text-format-basic-html__default__light__label.png
   - Related page screenshot: baseline-pages/config-text-format-basic-html__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline-pages/config-text-format-basic-html__default__light__page.png
...
```html
<label for="edit-order" class="form-item__label">Filter processing order</label>
```

### Drupal 12 with Admin Theme
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/form[1]/div[5]/div[1]/div[11]/label[1]`
   - Text sample: Lazy load images
   - Related element screenshot: candidate/config-text-format-basic-html__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/config-text-format-basic-html__default__light__label.png
...
2. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/form[1]/div[6]/label[1]`
   - Text sample: Filter processing order
   - Related element screenshot: candidate/config-text-format-basic-html__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/config-text-format-basic-html__default__light__label.png
   - Related page screenshot: candidate-pages/config-text-format-basic-html__default__light__page.png
