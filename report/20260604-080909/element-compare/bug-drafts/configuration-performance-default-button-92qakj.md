# Admin Theme (dark + light) Configuration Performance - Button style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Horizontal padding is noticeably higher: 27.5px vs 23.4px (+17.4%).
- This same issue was also identified in dark mode.

## Summary
Potential CSS regression in **Button** on **Configuration Performance** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
...
2. Open candidate page: http://drupal-12.ddev.site/admin/config/development/performance
...
## Evidence
- Baseline element screenshot: baseline/config-performance__default__light__button.png
- Candidate element screenshot: candidate/config-performance__default__light__button.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-performance__default__light__button.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/config-performance__default__light__button.png
- Baseline page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline-pages/config-performance__default__light__page.png
- Candidate page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate-pages/config-performance__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[2]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/config-performance__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-performance__default__light__button.png
   - Related page screenshot: baseline-pages/config-performance__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline-pages/config-performance__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[1]/div[2]/ul[1]/li[1]/button[1]`
   - Text sample: Extend Create
   - Related element screenshot: candidate/config-performance__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate/config-performance__default__light__button.png
   - Related page screenshot: candidate-pages/config-performance__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/candidate-pages/config-performance__default__light__page.png
