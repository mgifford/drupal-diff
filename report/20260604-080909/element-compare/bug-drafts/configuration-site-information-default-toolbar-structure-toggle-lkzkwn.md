# Admin Theme (dark + light) Configuration Site Information - Toolbar Structure Toggle Button style regression vs Drupal 11 Gin
...
## Evidence
- Baseline element screenshot: baseline/config-site-info__default__light__toolbar-structure-toggle.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-site-info__default__light__toolbar-structure-toggle.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[4]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/config-site-info__default__light__toolbar-structure-toggle.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260604-080909/element-compare/baseline/config-site-info__default__light__toolbar-structure-toggle.png
