...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1083px, received 1280px by 969px. 21228 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: structure-overview.png

Call log:
  - Expect "toHaveScreenshot(structure-overview.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 1280px by 1083px, received 1280px by 969px. 21217 pixels (ratio 0.02 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e243]:
    - banner [ref=e244]:
      - heading "Structure" [level=1] [ref=e248]
    - main [ref=e250]:
      - generic [ref=e254]:
        - generic [ref=e255]:
          - link "Block layout" [ref=e256] [cursor=pointer]:
            - /url: /admin/structure/block
          - generic [ref=e257]: Block layout
          - generic [ref=e258]: Configure what block content appears in your site's sidebars and other regions.
        - generic [ref=e259]:
          - link "Block types" [ref=e260] [cursor=pointer]:
            - /url: /admin/structure/block-content
          - generic [ref=e261]: Block types
          - generic [ref=e262]: Create and manage fields, forms, and display settings for your content blocks.
        - generic [ref=e263]:
          - link "Content types" [ref=e264] [cursor=pointer]:
            - /url: /admin/structure/types
          - generic [ref=e265]: Content types
          - generic [ref=e266]: Create and manage fields, forms, and display settings for your content.
        - generic [ref=e267]:
          - link "Display modes" [ref=e268] [cursor=pointer]:
            - /url: /admin/structure/display-modes
          - generic [ref=e269]: Display modes
          - generic [ref=e270]: Configure what displays are available for your content and forms.
        - generic [ref=e271]:
          - link "Menus" [ref=e272] [cursor=pointer]:
            - /url: /admin/structure/menu
          - generic [ref=e273]: Menus
          - generic [ref=e274]: Manage menus and menu links.
        - generic [ref=e275]:
          - link "Taxonomy" [ref=e276] [cursor=pointer]:
            - /url: /admin/structure/taxonomy
          - generic [ref=e277]: Taxonomy
          - generic [ref=e278]: Manage tagging, categorization, and classification of your content.
        - generic [ref=e279]:
          - link "Views" [ref=e280] [cursor=pointer]:
            - /url: /admin/structure/views
          - generic [ref=e281]: Views
          - generic [ref=e282]: Manage customized lists of content.
```
