...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/rtl-narrow/vrt/reports.spec.ts/reports-status.png, writing actual.
```
      ...
      - generic [ref=e33]:
        ...
        - generic [ref=e60]:
          ...
          - generic [ref=e71]:
            ...
            - text: Last run 1 hour 17 minutes ago
            - generic [ref=e73]:
              - text: (
