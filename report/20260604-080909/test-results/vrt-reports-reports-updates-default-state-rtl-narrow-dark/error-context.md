...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/rtl-narrow-dark/vrt/reports.spec.ts/reports-updates.png, writing actual.
```
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e18]:
    ...
    - main [ref=e37]:
      ...
      - generic [ref=e44]:
        - paragraph [ref=e45]:
          - text: "Last checked: 4 minutes 55 seconds ago ("
