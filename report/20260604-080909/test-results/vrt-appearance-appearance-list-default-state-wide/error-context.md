...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 2533px, received 1280px by 2564px. 88233 pixels (ratio 0.03 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 2533px, received 1280px by 2564px. 88222 pixels (ratio 0.03 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e243]:
    - banner [ref=e244]:
      - heading "Appearance" [level=1] [ref=e248]
    - generic [ref=e252]:
    ...
    - main [ref=e261]:
      - contentinfo "Error message" [ref=e266]:
        - heading "Error message" [level=2] [ref=e268]
        - generic [ref=e269]:
          - text: Your version of Drupal is no longer supported. Upgrading is strongly recommended! See the
          - link "available updates" [ref=e270] [cursor=pointer]:
            - /url: /admin/reports/updates
          - text: page for more information.
        - button "Hide" [ref=e271] [cursor=pointer]: Hide
      - complementary [ref=e275]:
        - paragraph [ref=e276]:
          - text: Set and configure the default theme for your website. Alternative
          - link "themes" [ref=e277] [cursor=pointer]:
            - /url: https://www.drupal.org/project/project_theme
          - text: are available.
        - paragraph [ref=e278]:
          - text: You can place blocks for each theme on the
          - link "block layout" [ref=e279] [cursor=pointer]:
            - /url: /admin/structure/block
          - text: page.
      - generic [ref=e281]:
        - generic [ref=e282]:
          - generic [ref=e283]:
            - heading "Installed themes" [level=2] [ref=e284]
            - generic [ref=e285]:
              - generic "Olivero 12.0-dev (default theme)" [ref=e286]:
                - img "Screenshot for Olivero theme" [ref=e288]
                - generic [ref=e289]:
                  - generic [ref=e290]:
                    - heading "Olivero 12.0-dev (default theme)" [level=3] [ref=e291]
                    - generic [ref=e292]: A clean, accessible, and flexible Drupal front-end theme.
                  - list [ref=e294]:
                    - listitem [ref=e295]:
                      - link "Settings" [ref=e296] [cursor=pointer]:
                        - /url: /admin/appearance/settings/olivero
              - generic "Claro 12.0-dev" [ref=e297]:
                - img "Screenshot for Claro theme" [ref=e299]
                - generic [ref=e300]:
                  - generic [ref=e301]:
                    - heading "Claro 12.0-dev" [level=3] [ref=e302]
                    - generic [ref=e303]: A clean, accessible, and powerful Drupal administration theme.
                  - list [ref=e305]:
                    - listitem [ref=e306]:
                      - link "Settings" [ref=e307] [cursor=pointer]:
                        - /url: /admin/appearance/settings/claro
                    - listitem [ref=e308]:
                      - link "Uninstall" [ref=e309] [cursor=pointer]:
                        - /url: /admin/appearance/uninstall?theme=claro
                    - listitem [ref=e310]:
                      - link "Set as default" [ref=e311] [cursor=pointer]:
                        - /url: /admin/appearance/default?theme=claro&token=5o34nNBUiphiFb9jm1BXHDrA9EOe2wuureDSkeLw8hc
              - generic "Default Admin 12.0-dev (administration theme, experimental theme)" [ref=e312]:
                - img "Screenshot for Default Admin theme" [ref=e314]
                - generic [ref=e315]:
                  - generic [ref=e316]:
                    - heading "Default Admin 12.0-dev (administration theme, experimental theme)" [level=3] [ref=e317]
                    - generic [ref=e318]: A clean, accessible and powerful Drupal administration theme with a strong focus on improving the editorial experience.
                  - list [ref=e320]:
                    - listitem [ref=e321]:
                      - link "Settings" [ref=e322] [cursor=pointer]:
                        - /url: /admin/appearance/settings/default_admin
                    - listitem [ref=e323]:
                      - link "Set as default" [ref=e324] [cursor=pointer]:
                        - /url: /admin/appearance/default?theme=default_admin&token=5o34nNBUiphiFb9jm1BXHDrA9EOe2wuureDSkeLw8hc
          - generic [ref=e325]:
            - heading "Uninstalled theme" [level=2] [ref=e326]
            - generic "Stark 12.0-dev" [ref=e328]:
              - img "Screenshot for Stark theme" [ref=e330]
              - generic [ref=e331]:
                - generic [ref=e332]:
                  - heading "Stark 12.0-dev" [level=3] [ref=e333]
                  - generic [ref=e334]:
                    ...
                    - link "Theming Guide" [ref=e335] [cursor=pointer]:
                      - /url: https://www.drupal.org/docs/develop/theming-drupal
                    - text: as a reference.
                - list [ref=e337]:
                  - listitem [ref=e338]:
                    - link "Install" [ref=e339] [cursor=pointer]:
                      - /url: /admin/appearance/install?theme=stark&token=F3zBZskGs5b-0cQ1GRYXqbV6OJQCEMTS8hcqymKU7og
                  - listitem [ref=e340]:
                    - link "Install and set as default" [ref=e341] [cursor=pointer]:
                      - /url: /admin/appearance/default?theme=stark&token=5o34nNBUiphiFb9jm1BXHDrA9EOe2wuureDSkeLw8hc
        - group [ref=e343]:
          - button "Administration theme" [expanded] [ref=e344] [cursor=pointer]: Administration theme
          - generic [ref=e345]:
            - generic [ref=e346]:
              - generic [ref=e347] [cursor=pointer]: Administration theme
              - combobox "Administration theme" [ref=e348]:
                - option "Default theme"
                - option "Claro"
                - option "Default Admin (Experimental)" [selected]
                - option "Olivero"
              - generic [ref=e349]: Choose "Default theme" to always use the same theme as the rest of the site.
            - generic [ref=e350]:
              - checkbox "Use the administration theme when editing or creating content" [checked] [ref=e351] [cursor=pointer]
              ...
              - generic [ref=e352]:
                ...
                - link "Permissions page" [ref=e353] [cursor=pointer]:
                  - /url: /admin/people/permissions/module/system
                - text: .
            - button "Save configuration" [ref=e355] [cursor=pointer]
```
