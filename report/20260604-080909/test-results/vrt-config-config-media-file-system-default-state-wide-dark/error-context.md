...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1739px, received 1280px by 1784px. 72032 pixels (ratio 0.04 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 1739px, received 1280px by 1784px. 72021 pixels (ratio 0.04 of all image pixels) are different.
