...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1265px, received 1280px by 975px. 44129 pixels (ratio 0.03 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 1265px, received 1280px by 975px. 44118 pixels (ratio 0.03 of all image pixels) are different.
