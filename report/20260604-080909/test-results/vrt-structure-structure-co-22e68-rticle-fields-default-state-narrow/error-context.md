...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 467px by 942px, received 375px by 812px. 35131 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - generic [ref=e24]:
    ...
    - generic [ref=e33]:
      ...
      - navigation "Primary tabs" [ref=e35]:
        - list [ref=e36]:
          - listitem [ref=e37]:
            - link "Manage fields" [ref=e38] [cursor=pointer]:
              - /url: /admin/structure/types/manage/article/fields
            - button "Tabs display toggle" [ref=e39]:
              - img [ref=e40]
    - main [ref=e43]:
      - table [ref=e49]:
        - rowgroup [ref=e50]:
          - row "Field Field type Operations" [ref=e51]:
            - columnheader "Field" [ref=e52]
            - columnheader "Field type" [ref=e53]
            - columnheader "Operations" [ref=e54]
        - rowgroup [ref=e55]:
          - row "Body body Single Long text with summary Edit List additional actions" [ref=e56]:
            - cell "Body body Single" [ref=e57]:
              - generic [ref=e58]:
                - generic [ref=e59]: Body body
                - generic [ref=e61]: Single
            - cell "Long text with summary" [ref=e62]:
              - generic [ref=e64]: Long text with summary
            - cell "Edit List additional actions" [ref=e65]:
              - list [ref=e68]:
                - listitem [ref=e69]:
                  - link "Edit" [ref=e70] [cursor=pointer]:
                    - /url: /admin/structure/types/manage/article/fields/node.article.body
                - listitem:
                  - button "List additional actions" [ref=e71]:
                    - generic [ref=e72]: List additional actions
```
