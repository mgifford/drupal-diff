...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/rtl-wide-dark/vrt/people.spec.ts/people-list.png, writing actual.
```
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e247]:
    ...
    - main [ref=e269]:
      - generic [ref=e274]:
        - form "Filter the contents of the People view" [ref=e276]:
          - generic [ref=e277]:
            - generic [ref=e278] [cursor=pointer]: Name or email contains
            - textbox "Name or email contains" [ref=e279]
          - generic [ref=e280]:
            - generic [ref=e281] [cursor=pointer]: Status
            - combobox "Status" [ref=e282]:
              - option "- Any -" [selected]
              - option "Active"
              - option "Blocked"
          - generic [ref=e283]:
            - generic [ref=e284] [cursor=pointer]: Role
            - combobox "Role" [ref=e285]:
              - option "- Any -" [selected]
              - option "Content editor"
              - option "Administrator"
          - generic [ref=e286]:
            - generic [ref=e287] [cursor=pointer]: Permission
            - combobox "Permission" [ref=e288]:
              - option "- Any -" [selected]
          ...
          - button "Filter" [ref=e290] [cursor=pointer]
        - generic [ref=e293]:
          - table [ref=e295]:
            - rowgroup [ref=e296]:
              - row "Select all rows in this table Username Status Roles Member for Sort ascending Last access Operations" [ref=e297]:
                - columnheader "Select all rows in this table" [ref=e298]:
                  - checkbox "Select all rows in this table" [ref=e299]
                - columnheader "Username" [ref=e300]:
                  - link "Username" [ref=e301] [cursor=pointer]:
                    - /url: "?user=&role=All&order=name&sort=asc"
                - columnheader "Status" [ref=e302]:
                  - link "Status" [ref=e303] [cursor=pointer]:
                    - /url: "?user=&role=All&order=status&sort=asc"
                - columnheader "Roles" [ref=e304]
                - columnheader "Member for Sort ascending" [ref=e305]:
                  - link "Member for Sort ascending" [ref=e306] [cursor=pointer]:
                    - /url: "?user=&role=All&order=created&sort=asc"
                    - text: Member for
                    - generic [ref=e308]: Sort ascending
                - columnheader "Last access" [ref=e309]:
                  - link "Last access" [ref=e310] [cursor=pointer]:
                    - /url: "?user=&role=All&order=access&sort=desc"
                - columnheader "Operations" [ref=e311]
            - rowgroup [ref=e312]:
              - row "Update the user editor1 editor1 Active 13 hours 53 minutes never Edit editor1 List additional actions" [ref=e313]:
                - cell "Update the user editor1" [ref=e314]:
                  - generic [ref=e315]:
                    - generic [ref=e316] [cursor=pointer]:
                      - text: Update the user
                      - emphasis [ref=e317]: editor1
                    - checkbox "Update the user editor1" [ref=e318]
                - cell "editor1" [ref=e319]:
                  - link "editor1" [ref=e320] [cursor=pointer]:
                    - /url: /user/2
                - cell "Active" [ref=e321]:
                  - generic [ref=e322]: Active
                - cell [ref=e323]
                - cell "13 hours 53 minutes" [ref=e324]
                - cell "never" [ref=e325]
                - cell "Edit editor1 List additional actions" [ref=e326]:
                  - list [ref=e329]:
                    - listitem [ref=e330]:
                      - link "Edit editor1" [ref=e331] [cursor=pointer]:
                        - /url: /user/2/edit?destination=/admin/people
                        - text: Edit
                    - listitem:
                      - button "List additional actions" [ref=e332]:
                        - generic [ref=e333]: List additional actions
              - row "Update the user admin admin Active Administrator 15 hours 15 minutes 3 minutes 2 seconds ago Edit admin List additional actions" [ref=e334]:
                - cell "Update the user admin" [ref=e335]:
                  - generic [ref=e336]:
                    - generic [ref=e337] [cursor=pointer]:
                      - text: Update the user
                      - emphasis [ref=e338]: admin
                    - checkbox "Update the user admin" [ref=e339]
                - cell "admin" [ref=e340]:
                  - link "admin" [ref=e341] [cursor=pointer]:
                    - /url: /user/1
                - cell "Active" [ref=e342]:
                  - generic [ref=e343]: Active
                - cell "Administrator" [ref=e344]:
                  - list [ref=e345]:
                    - listitem [ref=e346]: Administrator
                - cell "15 hours 15 minutes" [ref=e347]
                - cell "3 minutes 2 seconds ago" [ref=e348]
                - cell "Edit admin List additional actions" [ref=e349]:
                  - list [ref=e352]:
                    - listitem [ref=e353]:
                      - link "Edit admin" [ref=e354] [cursor=pointer]:
                        - /url: /user/1/edit?destination=/admin/people
                        - text: Edit
                    - listitem:
                      - button "List additional actions" [ref=e355]:
                        - generic [ref=e356]: List additional actions
          - group "Perform actions on the selected items in the People view" [ref=e357]:
            - generic [ref=e358]:
              - text: Perform actions on the selected items in the
              - emphasis [ref=e359]: People
              - text: view
            - generic [ref=e360]: No items selected
            - generic [ref=e361]:
              - text: "Action:"
              - combobox "Action:" [ref=e362]:
            ...
            - button "Apply to selected items" [ref=e364] [cursor=pointer]
  - generic [ref=e365]: No items selected
```
