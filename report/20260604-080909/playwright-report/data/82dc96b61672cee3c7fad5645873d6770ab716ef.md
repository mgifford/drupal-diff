...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/mid-dark/vrt/structure.spec.ts/structure-content-types-article-fields.png, writing actual.
```
