...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/rtl-mid-dark/vrt/structure.spec.ts/structure-content-types-article-display.png, writing actual.
```
