...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/rtl-wide-dark/vrt/structure.spec.ts/structure-menus.png, writing actual.
```
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e236]:
    ...
    - list [ref=e245]:
      - listitem [ref=e246]:
        - link "+Add menu" [ref=e247] [cursor=pointer]:
          - /url: /admin/structure/menu/add
  - generic [ref=e248]:
    - banner [ref=e249]:
      - heading "Menus" [level=1] [ref=e253]
    - main [ref=e255]:
      - complementary [ref=e259]:
        - paragraph [ref=e260]:
          - text: Each menu has a corresponding block that is managed on the
          - link "Block layout page" [ref=e261] [cursor=pointer]:
            - /url: /admin/structure/block
          - text: .
      - table [ref=e266]:
        - rowgroup [ref=e267]:
          - row "Title Description Operations" [ref=e268]:
            - columnheader "Title" [ref=e269]
            - columnheader "Description" [ref=e270]
            - columnheader "Operations" [ref=e271]
        - rowgroup [ref=e272]:
          - row "Administration Administrative task links Edit Administration List additional actions" [ref=e273]:
            - cell "Administration" [ref=e274]
            - cell "Administrative task links" [ref=e275]
            - cell "Edit Administration List additional actions" [ref=e276]:
              - list [ref=e279]:
                - listitem [ref=e280]:
                  - link "Edit Administration" [ref=e281] [cursor=pointer]:
                    - /url: /admin/structure/menu/manage/admin
                    - text: Edit menu
                - listitem:
                  - button "List additional actions" [ref=e282]:
                    - generic [ref=e283]: List additional actions
          - row "Content Content task links Edit Content List additional actions" [ref=e284]:
            - cell "Content" [ref=e285]
            - cell "Content task links" [ref=e286]
            - cell "Edit Content List additional actions" [ref=e287]:
              - list [ref=e290]:
                - listitem [ref=e291]:
                  - link "Edit Content" [ref=e292] [cursor=pointer]:
                    - /url: /admin/structure/menu/manage/content
                    - text: Edit menu
                - listitem:
                  - button "List additional actions" [ref=e293]:
                    - generic [ref=e294]: List additional actions
          - row "Footer Site information links Edit Footer List additional actions" [ref=e295]:
            - cell "Footer" [ref=e296]
            - cell "Site information links" [ref=e297]
            - cell "Edit Footer List additional actions" [ref=e298]:
              - list [ref=e301]:
                - listitem [ref=e302]:
                  - link "Edit Footer" [ref=e303] [cursor=pointer]:
                    - /url: /admin/structure/menu/manage/footer
                    - text: Edit menu
                - listitem:
                  - button "List additional actions" [ref=e304]:
                    - generic [ref=e305]: List additional actions
          - row "Main navigation Site section links Edit Main navigation List additional actions" [ref=e306]:
            - cell "Main navigation" [ref=e307]
            - cell "Site section links" [ref=e308]
            - cell "Edit Main navigation List additional actions" [ref=e309]:
              - list [ref=e312]:
                - listitem [ref=e313]:
                  - link "Edit Main navigation" [ref=e314] [cursor=pointer]:
                    - /url: /admin/structure/menu/manage/main
                    - text: Edit menu
                - listitem:
                  - button "List additional actions" [ref=e315]:
                    - generic [ref=e316]: List additional actions
          - row "Navigation user links User links to be used in Navigation Edit Navigation user links List additional actions" [ref=e317]:
            - cell "Navigation user links" [ref=e318]
            - cell "User links to be used in Navigation" [ref=e319]
            - cell "Edit Navigation user links List additional actions" [ref=e320]:
              - list [ref=e323]:
                - listitem [ref=e324]:
                  - link "Edit Navigation user links" [ref=e325] [cursor=pointer]:
                    - /url: /admin/structure/menu/manage/navigation-user-links
                    - text: Edit menu
                - listitem:
                  - button "List additional actions" [ref=e326]:
                    - generic [ref=e327]: List additional actions
          - row "Tools User tool links, often added by modules Edit Tools List additional actions" [ref=e328]:
            - cell "Tools" [ref=e329]
            - cell "User tool links, often added by modules" [ref=e330]
            - cell "Edit Tools List additional actions" [ref=e331]:
              - list [ref=e334]:
                - listitem [ref=e335]:
                  - link "Edit Tools" [ref=e336] [cursor=pointer]:
                    - /url: /admin/structure/menu/manage/tools
                    - text: Edit menu
                - listitem:
                  - button "List additional actions" [ref=e337]:
                    - generic [ref=e338]: List additional actions
          - row "User account menu Links related to the active user account Edit User account menu List additional actions" [ref=e339]:
            - cell "User account menu" [ref=e340]
            - cell "Links related to the active user account" [ref=e341]
            - cell "Edit User account menu List additional actions" [ref=e342]:
              - list [ref=e345]:
                - listitem [ref=e346]:
                  - link "Edit User account menu" [ref=e347] [cursor=pointer]:
