...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/rtl-wide-dark/vrt/reports.spec.ts/reports-status.png, writing actual.
```
        ...
        - generic [ref=e285]:
          ...
          - generic [ref=e287]:
            ...
            - generic [ref=e298]:
              ...
              - text: Last run 1 hour 19 minutes ago
              - generic [ref=e300]:
                - text: (
