...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1058px, received 1280px by 1011px. 31699 pixels (ratio 0.03 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 1058px, received 1280px by 1011px. 31688 pixels (ratio 0.03 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - navigation "Breadcrumb" [ref=e249]:
    ...
    - list [ref=e251]:
      - listitem:
        - link "Back to site" [ref=e252] [cursor=pointer]:
          - /url: /
      - listitem:
      ...
      - listitem:
        - text: /
        - link "Configuration" [ref=e254] [cursor=pointer]:
          - /url: /admin/config
      - listitem:
        - text: /
        - link "Development" [ref=e255] [cursor=pointer]:
          - /url: /admin/config/development
  - generic [ref=e256]:
    - banner [ref=e257]:
      - heading "Performance" [level=1] [ref=e261]
    - main [ref=e263]:
      - generic [ref=e266]:
        - group [ref=e268]:
          - button "Clear cache" [expanded] [ref=e269] [cursor=pointer]: Clear cache
          - button "Clear all caches" [ref=e271] [cursor=pointer]
        - generic [ref=e272]:
          - group [ref=e273]:
            - button "Caching" [expanded] [ref=e274] [cursor=pointer]: Caching
            - generic [ref=e276]:
              - generic [ref=e277] [cursor=pointer]: Browser and proxy cache maximum age
              - combobox "Browser and proxy cache maximum age" [ref=e278]:
                ...
                - option "12 hours"
                - option "1 day"
              - generic [ref=e279]: This is used as the value for max-age in Cache-Control headers.
          - group [ref=e280]:
            - button "Bandwidth optimization" [expanded] [ref=e281] [cursor=pointer]: Bandwidth optimization
            - generic [ref=e282]:
              - generic [ref=e283]: External resources can be optimized automatically, which can reduce both the size and number of requests made to your website.
              - generic [ref=e284]:
                - checkbox "Aggregate CSS files" [checked] [ref=e285] [cursor=pointer]
                - text: Aggregate CSS files
              - generic [ref=e286]:
                - checkbox "Aggregate JavaScript files" [checked] [ref=e287] [cursor=pointer]
                - text: Aggregate JavaScript files
          - button "Save configuration" [ref=e289] [cursor=pointer]
```
