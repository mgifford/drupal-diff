...
```
Error: A snapshot doesn't exist at /var/www/html/__screenshots__/rtl-mid-dark/vrt/reports.spec.ts/reports-updates.png, writing actual.
```
  ...
  - generic [ref=e18]:
    ...
    - main [ref=e36]:
      - complementary [ref=e40]:
        - paragraph [ref=e41]: Here you can find information about available updates for your installed modules and themes. Note that each module or theme is part of a "project", which may or may not have the same name, and might include multiple modules or themes within it.
      - generic [ref=e43]:
        - paragraph [ref=e44]:
          - text: "Last checked: 5 minutes 24 seconds ago ("
          - link "Check manually" [ref=e45] [cursor=pointer]:
            - /url: /admin/reports/updates/check?destination=/admin/reports/updates&token=xNlOYr1BOZjxRXmtFpc73YDBk8BZK4--i-UMrL4Yb_0
          - text: )
        - heading "Drupal core" [level=3] [ref=e46]
        - table [ref=e48]:
          - rowgroup [ref=e49]:
            - row [ref=e50]:
              - cell [ref=e51]:
                - generic [ref=e54]: Not supported!
                - generic [ref=e55]:
                  - link "Drupal core" [ref=e56] [cursor=pointer]:
