...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  36282 pixels (ratio 0.04 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - 36271 pixels (ratio 0.04 of all image pixels) are different.
    ...
    - generic [ref=e255]:
      - complementary [ref=e258]:
        - paragraph [ref=e259]:
          ...
          - link "Block layout page" [ref=e260] [cursor=pointer]:
            - /url: /admin/structure/block
          - text: .
      - generic [ref=e261]:
        - list [ref=e263]:
          - listitem [ref=e264]:
            - link "+Add menu" [ref=e265] [cursor=pointer]:
              - /url: /admin/structure/menu/add
        - table [ref=e267]:
          - rowgroup [ref=e268]:
            - row "Title Description Operations" [ref=e269]:
              - columnheader "Title" [ref=e270]
              - columnheader "Description" [ref=e271]
              - columnheader "Operations" [ref=e272]
          - rowgroup [ref=e273]:
            - row "Administration Administrative task links Edit Administration List additional actions" [ref=e274]:
              - cell "Administration" [ref=e275]
              - cell "Administrative task links" [ref=e276]
              - cell "Edit Administration List additional actions" [ref=e277]:
                - list [ref=e280]:
                  - listitem [ref=e281]:
                    - link "Edit Administration" [ref=e282] [cursor=pointer]:
                      - /url: /admin/structure/menu/manage/admin
                      - text: Edit menu
                  - listitem:
                    - button "List additional actions" [ref=e283]:
                      - generic [ref=e284]: List additional actions
            - row "Content Content task links Edit Content List additional actions" [ref=e285]:
              - cell "Content" [ref=e286]
              - cell "Content task links" [ref=e287]
              - cell "Edit Content List additional actions" [ref=e288]:
                - list [ref=e291]:
                  - listitem [ref=e292]:
                    - link "Edit Content" [ref=e293] [cursor=pointer]:
                      - /url: /admin/structure/menu/manage/content
                      - text: Edit menu
                  - listitem:
                    - button "List additional actions" [ref=e294]:
                      - generic [ref=e295]: List additional actions
            - row "Footer Site information links Edit Footer List additional actions" [ref=e296]:
              - cell "Footer" [ref=e297]
              - cell "Site information links" [ref=e298]
              - cell "Edit Footer List additional actions" [ref=e299]:
                - list [ref=e302]:
                  - listitem [ref=e303]:
                    - link "Edit Footer" [ref=e304] [cursor=pointer]:
                      - /url: /admin/structure/menu/manage/footer
                      - text: Edit menu
                  - listitem:
                    - button "List additional actions" [ref=e305]:
                      - generic [ref=e306]: List additional actions
            - row "Main navigation Site section links Edit Main navigation List additional actions" [ref=e307]:
              - cell "Main navigation" [ref=e308]
              - cell "Site section links" [ref=e309]
              - cell "Edit Main navigation List additional actions" [ref=e310]:
                - list [ref=e313]:
                  - listitem [ref=e314]:
                    - link "Edit Main navigation" [ref=e315] [cursor=pointer]:
                      - /url: /admin/structure/menu/manage/main
                      - text: Edit menu
                  - listitem:
                    - button "List additional actions" [ref=e316]:
                      - generic [ref=e317]: List additional actions
            - row "Navigation user links User links to be used in Navigation Edit Navigation user links List additional actions" [ref=e318]:
              - cell "Navigation user links" [ref=e319]
              - cell "User links to be used in Navigation" [ref=e320]
              - cell "Edit Navigation user links List additional actions" [ref=e321]:
                - list [ref=e324]:
                  - listitem [ref=e325]:
                    - link "Edit Navigation user links" [ref=e326] [cursor=pointer]:
            ...
            - row "Tools User tool links, often added by modules Edit Tools List additional actions" [ref=e329]:
              - cell "Tools" [ref=e330]
              - cell "User tool links, often added by modules" [ref=e331]
              - cell "Edit Tools List additional actions" [ref=e332]:
                - list [ref=e335]:
                  - listitem [ref=e336]:
                    - link "Edit Tools" [ref=e337] [cursor=pointer]:
                      - /url: /admin/structure/menu/manage/tools
                      - text: Edit menu
                  - listitem:
                    - button "List additional actions" [ref=e338]:
                      - generic [ref=e339]: List additional actions
            - row "User account menu Links related to the active user account Edit User account menu List additional actions" [ref=e340]:
              - cell "User account menu" [ref=e341]
              - cell "Links related to the active user account" [ref=e342]
              - cell "Edit User account menu List additional actions" [ref=e343]:
                - list [ref=e346]:
                  - listitem [ref=e347]:
                    - link "Edit User account menu" [ref=e348] [cursor=pointer]:
                      - /url: /admin/structure/menu/manage/account
                      - text: Edit menu
                  - listitem:
                    - button "List additional actions" [ref=e349]:
                      - generic [ref=e350]: List additional actions
```
