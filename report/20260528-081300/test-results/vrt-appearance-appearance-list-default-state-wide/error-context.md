...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 2533px, received 1280px by 2122px. 110020 pixels (ratio 0.04 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 2533px, received 1280px by 2122px. 110009 pixels (ratio 0.04 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e236]:
        ...
        - list [ref=e244]:
          ...
          - listitem [ref=e247]:
            - link "Administration" [ref=e248] [cursor=pointer]:
              - /url: /admin
      - generic [ref=e249]:
        - heading "Appearance" [level=1] [ref=e251]
        - generic [ref=e252]:
    ...
    - generic [ref=e261]:
      - contentinfo "Error message" [ref=e265]:
        - alert [ref=e266]:
      ...
      - complementary [ref=e273]:
        - paragraph [ref=e274]:
          ...
          - link "themes" [ref=e275] [cursor=pointer]:
            - /url: https://www.drupal.org/project/project_theme
          - text: are available.
        - paragraph [ref=e276]:
          - text: You can place blocks for each theme on the
          - link "block layout" [ref=e277] [cursor=pointer]:
            - /url: /admin/structure/block
          - text: page.
      - generic [ref=e279]:
        - generic [ref=e280]:
          - generic [ref=e281]:
            - heading "Installed themes" [level=2] [ref=e282]
            - generic [ref=e283]:
              - generic "Olivero 12.0-dev (default theme)" [ref=e284]:
                - img "Screenshot for Olivero theme" [ref=e286]
                - generic [ref=e287]:
                  - generic [ref=e288]:
                    - heading "Olivero 12.0-dev (default theme)" [level=3] [ref=e289]
                    - generic [ref=e290]: A clean, accessible, and flexible Drupal front-end theme.
                  - list [ref=e292]:
                    - listitem [ref=e293]:
                      - link "Settings" [ref=e294] [cursor=pointer]:
                        - /url: /admin/appearance/settings/olivero
              - generic "Claro 12.0-dev (administration theme)" [ref=e295]:
                - img "Screenshot for Claro theme" [ref=e297]
                - generic [ref=e298]:
                  - generic [ref=e299]:
                    - heading "Claro 12.0-dev (administration theme)" [level=3] [ref=e300]
                    - generic [ref=e301]: A clean, accessible, and powerful Drupal administration theme.
                  - list [ref=e303]:
                    - listitem [ref=e304]:
                      - link "Settings" [ref=e305] [cursor=pointer]:
                        - /url: /admin/appearance/settings/claro
                    - listitem [ref=e306]:
                      - link "Set as default" [ref=e307] [cursor=pointer]:
                        - /url: /admin/appearance/default?theme=claro&token=sC0yRBquB78VctMyTFknb5LQACsRLygKNMBnl_LB0uQ
          - separator [ref=e308]
          - generic [ref=e309]:
            - heading "Uninstalled themes" [level=2] [ref=e310]
            - generic [ref=e311]:
              - generic "Default Admin 12.0-dev (experimental theme)" [ref=e312]:
                - img "Screenshot for Default Admin theme" [ref=e314]
                - generic [ref=e315]:
                  - generic [ref=e316]:
                    - heading "Default Admin 12.0-dev (experimental theme)" [level=3] [ref=e317]
                  ...
                  - list [ref=e320]:
                    - listitem [ref=e321]:
                      - link "Install" [ref=e322] [cursor=pointer]:
                        - /url: /admin/appearance/install?theme=default_admin&token=vQWBaQj_WTZ5gq8P-F7EFNNGqSU1lD8QI3RAwcDMoI0
                    - listitem [ref=e323]:
                      - link "Install and set as default" [ref=e324] [cursor=pointer]:
                        - /url: /admin/appearance/default?theme=default_admin&token=sC0yRBquB78VctMyTFknb5LQACsRLygKNMBnl_LB0uQ
              - generic "Stark 12.0-dev" [ref=e325]:
                - img "Screenshot for Stark theme" [ref=e327]
                - generic [ref=e328]:
                  - generic [ref=e329]:
                    - heading "Stark 12.0-dev" [level=3] [ref=e330]
                    - generic [ref=e331]:
                      ...
                      - link "Theming Guide" [ref=e332] [cursor=pointer]:
                        - /url: https://www.drupal.org/docs/develop/theming-drupal
                      - text: as a reference.
                  - list [ref=e334]:
                    - listitem [ref=e335]:
                      - link "Install" [ref=e336] [cursor=pointer]:
                        - /url: /admin/appearance/install?theme=stark&token=vQWBaQj_WTZ5gq8P-F7EFNNGqSU1lD8QI3RAwcDMoI0
                    - listitem [ref=e337]:
                      - link "Install and set as default" [ref=e338] [cursor=pointer]:
                        - /url: /admin/appearance/default?theme=stark&token=sC0yRBquB78VctMyTFknb5LQACsRLygKNMBnl_LB0uQ
        - group [ref=e340]:
          - button "Administration theme" [expanded] [ref=e341] [cursor=pointer]: Administration theme
          - generic [ref=e342]:
            - generic [ref=e343]:
              - generic [ref=e344] [cursor=pointer]: Administration theme
              - combobox "Administration theme" [ref=e345]:
                - option "Default theme"
                - option "Claro" [selected]
                - option "Olivero"
              - generic [ref=e346]: Choose "Default theme" to always use the same theme as the rest of the site.
            - generic [ref=e347]:
              - checkbox "Use the administration theme when editing or creating content" [checked] [ref=e348]
              ...
              - generic [ref=e349]:
                ...
                - link "Permissions page" [ref=e350] [cursor=pointer]:
                  - /url: /admin/people/permissions/module/system
                - text: .
            - button "Save configuration" [ref=e352] [cursor=pointer]
```
