...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1265px, received 1280px by 911px. 42254 pixels (ratio 0.03 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 1265px, received 1280px by 911px. 42243 pixels (ratio 0.03 of all image pixels) are different.
        ...
        - list [ref=e244]:
          ...
          - listitem [ref=e251]:
            - link "Content types" [ref=e252] [cursor=pointer]:
              - /url: /admin/structure/types
          - listitem [ref=e253]:
            - link "Article" [ref=e254] [cursor=pointer]:
              - /url: /admin/structure/types/manage/article
      - generic [ref=e255]:
        - heading "Manage display" [level=1] [ref=e257]
        - generic [ref=e258]:
          - heading "Primary tabs" [level=2] [ref=e259]
          - navigation "Primary tabs" [ref=e260]:
            - list [ref=e261]:
              - listitem [ref=e262]:
                - link "Edit" [ref=e263] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article
              - listitem [ref=e264]:
                - link "Manage fields" [ref=e265] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/fields
              - listitem [ref=e266]:
                - link "Manage form display" [ref=e267] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/form-display
              - listitem [ref=e268]:
                - link "Manage display" [ref=e269] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/display
              - listitem [ref=e270]:
                - link "Manage permissions" [ref=e271] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/permissions
    - generic [ref=e272]:
      - generic [ref=e274]:
        - heading "Secondary tabs" [level=2] [ref=e275]
        - navigation "Secondary tabs" [ref=e276]:
          - list [ref=e277]:
            - listitem [ref=e278]:
              - link "Overview" [ref=e279] [cursor=pointer]:
                - /url: /admin/structure/types/manage/article/display
            - listitem [ref=e280]:
              - link "Default" [ref=e281] [cursor=pointer]:
      ...
      - generic [ref=e282]:
        - complementary [ref=e285]:
          - paragraph [ref=e286]:
            ...
            - emphasis [ref=e287]: Article
            - text: . Click
            - emphasis [ref=e288]: Manage
            - text: on any enabled view mode to configure which fields are shown and how they are displayed.
        - generic [ref=e290]:
          - generic [ref=e291]:
            - generic [ref=e292]:
              - heading "Enabled view modes" [level=2] [ref=e293]
              - link "Manage view modes" [ref=e294] [cursor=pointer]:
          ...
          - generic [ref=e312]:
            ...
            - table [ref=e314]:
              - rowgroup [ref=e315]:
                - row "View mode Description Operations" [ref=e316]:
                  - columnheader "View mode" [ref=e317]
                  - columnheader "Description" [ref=e318]
                  - columnheader "Operations" [ref=e319]
              - rowgroup [ref=e320]:
                - row "Full content Enable (Full content)" [ref=e321]:
                  - cell "Full content" [ref=e322]
                  - cell [ref=e323]
                  - cell "Enable (Full content)" [ref=e324]:
                    - list [ref=e327]:
                      - listitem [ref=e328]:
                        - link "Enable (Full content)" [ref=e329] [cursor=pointer]:
                          - /url: /admin/structure/types/manage/article/display/full/enable?token=wvvdvF2LaW1D0qgKMPhVw27l2sktlSNHNY2bXMYZJhU
                          - text: Enable
                          - generic [ref=e330]: (Full content)
                - row "RSS Enable (RSS)" [ref=e331]:
                  - cell "RSS" [ref=e332]
                  - cell [ref=e333]
                  - cell "Enable (RSS)" [ref=e334]:
                    - list [ref=e337]:
                      - listitem [ref=e338]:
                        - link "Enable (RSS)" [ref=e339] [cursor=pointer]:
                          - /url: /admin/structure/types/manage/article/display/rss/enable?token=4AsjJ_Kd7cbPtON75KQd_cN30yADOgBoHYAchne7Jdg
                          - text: Enable
                          - generic [ref=e340]: (RSS)
                - row "Teaser Enable (Teaser)" [ref=e341]:
                  - cell "Teaser" [ref=e342]
                  - cell [ref=e343]
                  - cell "Enable (Teaser)" [ref=e344]:
                    - list [ref=e347]:
                      - listitem [ref=e348]:
                        - link "Enable (Teaser)" [ref=e349] [cursor=pointer]:
                          - /url: /admin/structure/types/manage/article/display/teaser/enable?token=2tzZ3oFXTKw1EAmKsDRHwaER_L4krCb-XcxWv8U_3lw
                          - text: Enable
                          - generic [ref=e350]: (Teaser)
```
