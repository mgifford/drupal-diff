...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  29970 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: structure-taxonomy.png

Call log:
  - Expect "toHaveScreenshot(structure-taxonomy.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 29959 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - main [ref=e236]:
    ...
    - generic [ref=e255]:
      - complementary [ref=e258]:
        - paragraph [ref=e259]: Taxonomy is for categorizing content. Terms are grouped into vocabularies. For example, a vocabulary called "Fruit" would contain the terms "Apple" and "Banana".
      - generic [ref=e260]:
        - list [ref=e262]:
          - listitem [ref=e263]:
            - link "+Add vocabulary" [ref=e264] [cursor=pointer]:
              - /url: /admin/structure/taxonomy/add
        - table [ref=e266]:
          - rowgroup [ref=e267]:
            - row "Vocabulary name Description Operations" [ref=e268]:
              - columnheader "Vocabulary name" [ref=e269]
              - columnheader "Description" [ref=e270]
              - columnheader "Operations" [ref=e271]
          - rowgroup [ref=e272]:
            - row "Tags List terms List additional actions" [ref=e273]:
              - cell "Tags" [ref=e274]
              - cell [ref=e275]
              - cell "List terms List additional actions" [ref=e276]:
                - list [ref=e279]:
                  - listitem [ref=e280]:
                    - link "List terms" [ref=e281] [cursor=pointer]:
