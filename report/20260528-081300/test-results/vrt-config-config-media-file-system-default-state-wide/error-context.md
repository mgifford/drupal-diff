...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1739px, received 1280px by 1585px. 76868 pixels (ratio 0.04 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 1739px, received 1280px by 1585px. 76857 pixels (ratio 0.04 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e243]:
    - generic [ref=e246]:
      - navigation "Breadcrumb" [ref=e249]:
        - heading "Breadcrumb" [level=2] [ref=e250]
        - list [ref=e251]:
          - listitem [ref=e252]:
            - link "Home" [ref=e253] [cursor=pointer]:
              - /url: /
          - listitem [ref=e254]:
            - link "Administration" [ref=e255] [cursor=pointer]:
              - /url: /admin
          - listitem [ref=e256]:
            - link "Configuration" [ref=e257] [cursor=pointer]:
              - /url: /admin/config
          - listitem [ref=e258]:
            - link "Media" [ref=e259] [cursor=pointer]:
              - /url: /admin/config/media
      - heading "File system" [level=1] [ref=e262]
    - generic [ref=e267]:
      - generic [ref=e268]:
        - generic [ref=e269] [cursor=pointer]: Public file system path
        - text: sites/default/files
        - generic [ref=e270]: A local file system path where public files will be stored. This directory must exist and be writable by Drupal. This directory must be relative to the Drupal installation directory and be accessible over the web. This must be changed in settings.php
      - generic [ref=e271]:
        - generic [ref=e272] [cursor=pointer]: Public file base URL
        - text: http://localhost/sites/default/files
        - generic [ref=e273]: The base URL that will be used for public file URLs. This can be changed in settings.php
      - generic [ref=e274]:
        - generic [ref=e275] [cursor=pointer]: Optimized assets file system path
        - text: sites/default/files
        - generic [ref=e276]: A local file system path where optimized assets files will be stored. This directory must exist and be writable by Drupal. This directory must be relative to the Drupal installation directory and be accessible over the web. This must be changed in settings.php
      - generic [ref=e277]:
        - generic [ref=e278] [cursor=pointer]: Private file system path
        - text: Not set
        - generic [ref=e279]: An existing local file system path for storing private files. It should be writable by Drupal and not accessible over the web. This must be changed in settings.php
      - generic [ref=e280]:
        - generic [ref=e281] [cursor=pointer]: Temporary directory
        - text: /tmp
        - generic [ref=e282]: A local file system path where temporary files will be stored. This directory should not be accessible over the web. This must be changed in settings.php.
      - group "Default download method" [ref=e283]:
        - generic [ref=e285]: Default download method
        - generic [ref=e286]:
          - generic [ref=e288]:
            - radio "Public local files served by the webserver." [checked] [ref=e289]
            - text: Public local files served by the webserver.
          - generic [ref=e290]: This setting is used as the preferred download method. The use of public files is more efficient, but does not provide any access control.
      - generic [ref=e291]:
        - generic [ref=e292] [cursor=pointer]: Delete temporary files after
        - combobox "Delete temporary files after" [ref=e293]:
          - option "Never"
        ...
        - generic [ref=e294]:
          ...
          - strong [ref=e295]: "Warning:"
          - text: If enabled, temporary files will be permanently deleted and may not be recoverable.
      - group [ref=e296]:
        - button "Sanitize filenames" [expanded] [ref=e297] [cursor=pointer]: Sanitize filenames
        - generic [ref=e298]:
          - generic [ref=e299]: These settings only apply to new files as they are uploaded. Changes here do not affect existing file names.
          - generic [ref=e300]:
            - generic [ref=e301] [cursor=pointer]: Replacement character
            - combobox "Replacement character" [ref=e302]:
              - option "Dash (-)" [selected]
              - option "Underscore (_)"
            - generic [ref=e303]: Used when replacing whitespace, replacing non-alphanumeric characters or transliterating unknown characters.
          - generic [ref=e304]:
            - checkbox "Transliterate" [ref=e305]
            - text: Transliterate
            - generic [ref=e306]: Transliteration replaces any characters that are not alphanumeric, underscores, periods or hyphens with the replacement character. It ensures filenames only contain ASCII characters. It is recommended to keep transliteration enabled.
          - generic [ref=e307]:
            - checkbox "Replace whitespace with the replacement character" [ref=e308]
            - text: Replace whitespace with the replacement character
          - generic [ref=e309]:
            - checkbox "Replace non-alphanumeric characters with the replacement character" [ref=e310]
            - text: Replace non-alphanumeric characters with the replacement character
            - generic [ref=e311]: Alphanumeric characters, dots (.), underscores (_) and dashes (-) are preserved.
          - generic [ref=e312]:
            - checkbox "Replace sequences of dots, underscores and/or dashes with the replacement character" [ref=e313]
            - text: Replace sequences of dots, underscores and/or dashes with the replacement character
          - generic [ref=e314]:
            - checkbox "Convert to lowercase" [ref=e315]
            - text: Convert to lowercase
      - button "Save configuration" [ref=e317] [cursor=pointer]
```
