# [Admin Theme][light] People - Table Body Cell style regression vs Drupal 11 Gin
...
## Evidence
- Baseline element screenshot: baseline/people__light__table-cell.png
- Candidate element screenshot: candidate/people__light__table-cell.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-081300/element-compare/baseline/people__light__table-cell.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-081300/element-compare/candidate/people__light__table-cell.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/div[1]/div[1]/div[2]/div[1]/form[1]/div[2]/table[1]/tbody[1]/tr[1]/td[1]`
   - Text sample: Update the user editor1

```html
<td class="views-field views-field-user-bulk-form"><div class="js-form-item form-item js-form-type-checkbox form-type--checkbox form-type--boolean js-form-item-user-bulk-form-0 form-item--user-bulk-form-0 form-item--no-label"> <label for="edit-user-bulk-form-0" class="form-item__label visually-hidden">Update the user <em class="placeholder">editor1</em></label> <input data-drupal-selector="edit-user-bulk-form-0" type="checkbox" id="edit-user-bulk-form-0" name="user_bulk_form[0]" value="WyJlbiIsIjIiXQ==" class="form-checkbox form-boolean form-boolean--type-checkbox" style=""> </div> </td>
```
...
```html
<td headers="view-name-table-column" class="views-field views-field-name"><a title="View user profile." href="/user/2" class="username">editor1</a> </td>
```
