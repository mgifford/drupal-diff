# [Admin Theme][light] Content - Form Item Wrapper style regression vs Drupal 11 Gin
...
- http://drupal-git.ddev.site:8080/sites/default/files/css/css_NxYRStE8_1b8wzt-ofkkqJHMbcuTOCLmr3_N0PhVVXg.css?delta=1&language=en&theme=claro&include=eJxtzlEOgzAIgOELWXsmaknHhmAodW6nXzNNjNleePjyQ5gYTGNhTcCh-otJyjCpOG7egGO2tgCPp4RePGpPDOOk86KC4nUUWKmAk0oIrsoJLKTmrrKnxx24w3aBTMBarmS6_Fl1SIw3hIz261XNdxW1GZjeOJwvRerfm_T4tGElfNb4neOsuTF-AM1KaGI :: *
- http://drupal-git.ddev.site:8080/sites/default/files/css/css_NxYRStE8_1b8wzt-ofkkqJHMbcuTOCLmr3_N0PhVVXg.css?delta=1&language=en&theme=claro&include=eJxtzlEOgzAIgOELWXsmaknHhmAodW6nXzNNjNleePjyQ5gYTGNhTcCh-otJyjCpOG7egGO2tgCPp4RePGpPDOOk86KC4nUUWKmAk0oIrsoJLKTmrrKnxx24w3aBTMBarmS6_Fl1SIw3hIz261XNdxW1GZjeOJwvRerfm_T4tGElfNb4neOsuTF-AM1KaGI :: .form-item
- http://drupal-git.ddev.site:8080/sites/default/files/css/css_NxYRStE8_1b8wzt-ofkkqJHMbcuTOCLmr3_N0PhVVXg.css?delta=1&language=en&theme=claro&include=eJxtzlEOgzAIgOELWXsmaknHhmAodW6nXzNNjNleePjyQ5gYTGNhTcCh-otJyjCpOG7egGO2tgCPp4RePGpPDOOk86KC4nUUWKmAk0oIrsoJLKTmrrKnxx24w3aBTMBarmS6_Fl1SIw3hIz261XNdxW1GZjeOJwvRerfm_T4tGElfNb4neOsuTF-AM1KaGI :: .views-exposed-form__item
...
## Evidence
- Baseline element screenshot: baseline/content__light__form-item.png
- Candidate element screenshot: candidate/content__light__form-item.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-081300/element-compare/baseline/content__light__form-item.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-081300/element-compare/candidate/content__light__form-item.png
...
```html
<div class="views-exposed-form__item js-form-item form-item js-form-type-textfield form-type--textfield js-form-item-title form-item--title"> <label for="edit-title" class="form-item__label">Title</label> <input data-drupal-selector="edit-title" type="text" id="edit-title" name="title" value="" size="30" maxlength="128" class="form-text form-element form-element--type-text form-element--api-textfield" style=""> </div>
```

2. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/div[1]/div[1]/div[1]/form[1]/div[2]`
   - Text sample: Content type - Any - Article Basic page

```html
<div class="views-exposed-form__item js-form-item form-item js-form-type-select form-type--select js-form-item-type form-item--type"> <label for="edit-type" class="form-item__label">Content type</label> <select data-drupal-selector="edit-type" id="edit-type" name="type" class="form-select form-element form-element--type-select"> <option value="All" selected="selected">- Any -</option> <option value="article">Article</option> <option value="page">Basic page</option> </select> </div>
```
