...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1191px, received 1280px by 1163px. 44389 pixels (ratio 0.03 of all image pixels) are different.
        ...
        - list [ref=e244]:
          ...
          - listitem [ref=e249]:
            - link "Structure" [ref=e250] [cursor=pointer]:
              - /url: /admin/structure
          - listitem [ref=e251]:
            - link "Content types" [ref=e252] [cursor=pointer]:
              - /url: /admin/structure/types
      - generic [ref=e253]:
        - heading "Edit Article content type" [level=1] [ref=e255]:
          - text: Edit
          - emphasis [ref=e256]: Article
          - text: content type
        - generic [ref=e257]:
          ...
          - navigation "Primary tabs" [ref=e259]:
            - list [ref=e260]:
              ...
              - listitem [ref=e263]:
                - link "Manage fields" [ref=e264] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/fields
              - listitem [ref=e265]:
                - link "Manage form display" [ref=e266] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/form-display
              - listitem [ref=e267]:
                - link "Manage display" [ref=e268] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/display
              - listitem [ref=e269]:
                - link "Manage permissions" [ref=e270] [cursor=pointer]:
                  - /url: /admin/structure/types/manage/article/permissions
    - generic [ref=e275]:
      - generic [ref=e276]:
        - generic [ref=e277] [cursor=pointer]: Name *
        - textbox "Name *" [ref=e278]: Article
        - generic [ref=e280]: "Machine name: article"
        - generic [ref=e281]:
          - text: The human-readable name for this content type, displayed on the
          - emphasis [ref=e282]: Content types
          - text: page.
      - text: "*"
      - generic [ref=e283]:
        - generic [ref=e284] [cursor=pointer]: Description
        - textbox "Description" [ref=e286]: Generated for visual regression seeding
        - generic [ref=e287]:
          - text: Displays on the
          - emphasis [ref=e288]: Content types
          - text: page.
      - generic [ref=e289]:
        - generic [ref=e290] [cursor=pointer]: Vertical Tabs
        - generic [ref=e291]:
          - list [ref=e292]:
            - listitem [ref=e293]:
              - link "Submission form settings Title (active tab)" [ref=e294] [cursor=pointer]:
                - /url: "#edit-submission"
                - generic [ref=e295]:
                  - strong [ref=e296]: Submission form settings
                  - generic [ref=e297]: Title
                - generic [ref=e298]: (active tab)
            - listitem [ref=e299]:
              - link "Publishing options Published, Create new revision" [ref=e300] [cursor=pointer]:
                - /url: "#edit-workflow"
                - generic [ref=e301]:
                  - strong [ref=e302]: Publishing options
                  - generic [ref=e303]: Published, Create new revision
            - listitem [ref=e304]:
              - link "Display settings Display author and date information" [ref=e305] [cursor=pointer]:
                - /url: "#edit-display"
                - generic [ref=e306]:
                  - strong [ref=e307]: Display settings
                  - generic [ref=e308]: Display author and date information
            - listitem [ref=e309]:
              - link "Menu settings" [ref=e310] [cursor=pointer]:
                - /url: "#edit-menu"
                - strong [ref=e312]: Menu settings
          - group [ref=e314]:
            - generic [ref=e316]:
              - generic [ref=e317]:
                - generic [ref=e318] [cursor=pointer]: Title field label *
                - textbox "Title field label *" [ref=e319]: Title
              - group "Preview before submitting" [ref=e320]:
                - generic [ref=e322]: Preview before submitting
                - generic [ref=e324]:
                  - generic [ref=e325]:
                    - radio "Disabled" [ref=e326]
                    - text: Disabled
                  - generic [ref=e327]:
                    - radio "Optional" [checked] [ref=e328]
                    - text: Optional
                  - generic [ref=e329]:
                    - radio "Required" [ref=e330]
                    - text: Required
              - generic [ref=e331]:
                - generic [ref=e332] [cursor=pointer]: Explanation or submission guidelines
                - textbox "Explanation or submission guidelines" [ref=e334]
                - generic [ref=e335]: This text will be displayed at the top of the page when creating or editing content of this type.
      - generic [ref=e336]:
