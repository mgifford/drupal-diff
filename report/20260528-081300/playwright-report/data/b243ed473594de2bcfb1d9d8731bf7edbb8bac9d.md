...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1083px, received 1280px by 900px. 23247 pixels (ratio 0.02 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 1083px, received 1280px by 900px. 23236 pixels (ratio 0.02 of all image pixels) are different.
        ...
        - list [ref=e244]:
          ...
          - listitem [ref=e247]:
            - link "Administration" [ref=e248] [cursor=pointer]:
              - /url: /admin
      - heading "Structure" [level=1] [ref=e251]
    - generic [ref=e256]:
      - generic [ref=e257]:
        - term [ref=e258]:
          - link "Block layout" [ref=e259] [cursor=pointer]:
            - /url: /admin/structure/block
        - definition [ref=e260]: Configure what block content appears in your site's sidebars and other regions.
      - generic [ref=e261]:
        - term [ref=e262]:
          - link "Block types" [ref=e263] [cursor=pointer]:
            - /url: /admin/structure/block-content
        - definition [ref=e264]: Create and manage fields, forms, and display settings for your content blocks.
      - generic [ref=e265]:
        - term [ref=e266]:
          - link "Content types" [ref=e267] [cursor=pointer]:
            - /url: /admin/structure/types
        - definition [ref=e268]: Create and manage fields, forms, and display settings for your content.
      - generic [ref=e269]:
        - term [ref=e270]:
          - link "Display modes" [ref=e271] [cursor=pointer]:
            - /url: /admin/structure/display-modes
        - definition [ref=e272]: Configure what displays are available for your content and forms.
      - generic [ref=e273]:
        - term [ref=e274]:
          - link "Menus" [ref=e275] [cursor=pointer]:
            - /url: /admin/structure/menu
        - definition [ref=e276]: Manage menus and menu links.
      - generic [ref=e277]:
        - term [ref=e278]:
          - link "Taxonomy" [ref=e279] [cursor=pointer]:
            - /url: /admin/structure/taxonomy
        - definition [ref=e280]: Manage tagging, categorization, and classification of your content.
      - generic [ref=e281]:
        - term [ref=e282]:
          - link "Views" [ref=e283] [cursor=pointer]:
            - /url: /admin/structure/views
        - definition [ref=e284]: Manage customized lists of content.
```
