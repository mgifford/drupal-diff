...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  31683 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: structure-content-types.png

Call log:
  - Expect "toHaveScreenshot(structure-content-types.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 31672 pixels (ratio 0.03 of all image pixels) are different.
        ...
        - list [ref=e244]:
          ...
          - listitem [ref=e249]:
            - link "Structure" [ref=e250] [cursor=pointer]:
              - /url: /admin/structure
      - heading "Content types" [level=1] [ref=e253]
    - generic [ref=e256]:
      - list [ref=e258]:
        - listitem [ref=e259]:
          - link "+Add content type" [ref=e260] [cursor=pointer]:
            - /url: /admin/structure/types/add
      - table [ref=e262]:
        - rowgroup [ref=e263]:
          - row "Name Description Operations" [ref=e264]:
            - columnheader "Name" [ref=e265]
            - columnheader "Description" [ref=e266]
            - columnheader "Operations" [ref=e267]
        - rowgroup [ref=e268]:
          - row "Article Generated for visual regression seeding Manage fields List additional actions" [ref=e269]:
            - cell "Article" [ref=e270]
            - cell "Generated for visual regression seeding" [ref=e271]
            - cell "Manage fields List additional actions" [ref=e272]:
              - list [ref=e275]:
                - listitem [ref=e276]:
                  - link "Manage fields" [ref=e277] [cursor=pointer]:
                    - /url: /admin/structure/types/manage/article/fields
                - listitem:
                  - button "List additional actions" [ref=e278]:
                    - generic [ref=e279]: List additional actions
          - row "Basic page Generated for visual regression seeding Manage fields List additional actions" [ref=e280]:
            - cell "Basic page" [ref=e281]
            - cell "Generated for visual regression seeding" [ref=e282]
            - cell "Manage fields List additional actions" [ref=e283]:
              - list [ref=e286]:
                - listitem [ref=e287]:
                  - link "Manage fields" [ref=e288] [cursor=pointer]:
                    - /url: /admin/structure/types/manage/page/fields
                - listitem:
                  - button "List additional actions" [ref=e289]:
                    - generic [ref=e290]: List additional actions
```
