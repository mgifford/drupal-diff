...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 2000px, received 1280px by 1805px. 54951 pixels (ratio 0.03 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 2000px, received 1280px by 1805px. 54940 pixels (ratio 0.03 of all image pixels) are different.
        ...
        - list [ref=e244]:
          ...
          - listitem [ref=e247]:
            - link "Administration" [ref=e248] [cursor=pointer]:
              - /url: /admin
      - heading "Configuration" [level=1] [ref=e251]
    - generic [ref=e253]:
      - contentinfo "Error message" [ref=e257]:
        - alert [ref=e258]:
          - heading "Error message" [level=2] [ref=e260]
          - generic [ref=e261]:
            - text: One or more problems were detected with your Drupal installation. Check the
            - link "status report" [ref=e262] [cursor=pointer]:
              - /url: /admin/reports/status
            - text: for more information.
      - generic [ref=e264]:
        - link "Hide descriptions" [ref=e266] [cursor=pointer]:
          - /url: /admin/compact/on?destination=/admin/config
        - generic [ref=e267]:
          - generic [ref=e268]:
            - generic [ref=e269]:
              - heading "People" [level=3] [ref=e270]
              - generic [ref=e273]:
                - term [ref=e274]:
                  - link "Account settings" [ref=e275] [cursor=pointer]:
                    - /url: /admin/config/people/accounts
                - definition [ref=e276]: Configure default user account settings, including fields, registration requirements, and email messages.
            - generic [ref=e277]:
              - heading "Content authoring" [level=3] [ref=e278]
              - generic [ref=e281]:
                - term [ref=e282]:
                  - link "Text formats and editors" [ref=e283] [cursor=pointer]:
                    - /url: /admin/config/content/formats
                - definition [ref=e284]: Select and configure text editors, and how content is filtered when displayed.
            - generic [ref=e285]:
              - heading "Development" [level=3] [ref=e286]
              - generic [ref=e288]:
                - generic [ref=e289]:
                  - term [ref=e290]:
                    - link "Performance" [ref=e291] [cursor=pointer]:
                      - /url: /admin/config/development/performance
                  - definition [ref=e292]: Configure caching and bandwidth optimization.
                - generic [ref=e293]:
                  - term [ref=e294]:
                    - link "Development settings" [ref=e295] [cursor=pointer]:
                      - /url: /admin/config/development/settings
                  - definition [ref=e296]: Configure theme development settings
                - generic [ref=e297]:
                  - term [ref=e298]:
                    - link "Logging and errors" [ref=e299] [cursor=pointer]:
                      - /url: /admin/config/development/logging
                  - definition [ref=e300]: Configure the display of error messages and database logging.
                - generic [ref=e301]:
                  - term [ref=e302]:
                    - link "Maintenance mode" [ref=e303] [cursor=pointer]:
                      - /url: /admin/config/development/maintenance
                  - definition [ref=e304]: Take the site offline for updates and other maintenance tasks.
                - generic [ref=e305]:
                  - term [ref=e306]:
                    - link "Configuration synchronization" [ref=e307] [cursor=pointer]:
                      - /url: /admin/config/development/configuration
                  - definition [ref=e308]: Import and export your configuration.
            - generic [ref=e309]:
              - heading "Search and metadata" [level=3] [ref=e310]
              - generic [ref=e313]:
                - term [ref=e314]:
                  - link "URL aliases" [ref=e315] [cursor=pointer]:
                    - /url: /admin/config/search/path
                - definition [ref=e316]: Add custom URLs to existing paths.
            - generic [ref=e317]:
              - heading "Web services" [level=3] [ref=e318]
              - generic [ref=e321]:
                - term [ref=e322]:
                  - link "Menu Linkset Settings" [ref=e323] [cursor=pointer]:
                    - /url: /admin/config/services/linkset
                - definition [ref=e324]: Enable or disable the menu linkset endpoint
          - generic [ref=e325]:
            - generic [ref=e326]:
              - heading "System" [level=3] [ref=e327]
              - generic [ref=e329]:
                - generic [ref=e330]:
                  - term [ref=e331]:
                    - link "Basic site settings" [ref=e332] [cursor=pointer]:
                      - /url: /admin/config/system/site-information
                  - definition [ref=e333]: Change site name, email address, slogan, default front page, and error pages.
                - generic [ref=e334]:
                  - term [ref=e335]:
                    - link "Cron" [ref=e336] [cursor=pointer]:
                      - /url: /admin/config/system/cron
                  - definition [ref=e337]: Manage automatic site maintenance tasks.
            - generic [ref=e338]:
              - heading "User interface" [level=3] [ref=e339]
              - generic [ref=e341]:
                - generic [ref=e342]:
                  - term [ref=e343]:
                    - link "Navigation blocks" [ref=e344] [cursor=pointer]:
                      - /url: /admin/config/user-interface/navigation-block
                  - definition [ref=e345]: Manage navigation blocks.
                - generic [ref=e346]:
                  - term [ref=e347]:
                    - link "Navigation settings" [ref=e348] [cursor=pointer]:
                      - /url: /admin/config/user-interface/navigation/settings
                  - definition [ref=e349]: Manage navigation settings.
            - generic [ref=e350]:
              - heading "Media" [level=3] [ref=e351]
              - generic [ref=e353]:
                - generic [ref=e354]:
                  - term [ref=e355]:
                    - link "File system" [ref=e356] [cursor=pointer]:
                      - /url: /admin/config/media/file-system
                  - definition [ref=e357]: Configure the location of uploaded files and how they are accessed.
                - generic [ref=e358]:
                  - term [ref=e359]:
                    - link "Image styles" [ref=e360] [cursor=pointer]:
                      - /url: /admin/config/media/image-styles
                  - definition [ref=e361]: Configure styles that can be used for resizing or adjusting images on display.
                - generic [ref=e362]:
                  - term [ref=e363]:
                    - link "Image toolkit" [ref=e364] [cursor=pointer]:
                      - /url: /admin/config/media/image-toolkit
                  - definition [ref=e365]: Choose which image toolkit to use if you have installed optional toolkits.
            - generic [ref=e366]:
              - heading "Region and language" [level=3] [ref=e367]
              - generic [ref=e369]:
                - generic [ref=e370]:
                  - term [ref=e371]:
                    - link "Regional settings" [ref=e372] [cursor=pointer]:
                      - /url: /admin/config/regional/settings
                  - definition [ref=e373]: Configure the locale and timezone settings.
                - generic [ref=e374]:
                  - term [ref=e375]:
                    - link "Date and time formats" [ref=e376] [cursor=pointer]:
                      - /url: /admin/config/regional/date-time
                  - definition [ref=e377]: Configure how dates and times are displayed.
```
