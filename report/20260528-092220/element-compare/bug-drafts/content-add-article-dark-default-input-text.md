...
- Component width is noticeably narrower: 264.8px vs 324.3px (-18.4%).
...
1. XPath: `//*[@id="edit-title-0-value"]`
   - Related element screenshot: baseline/content-add-article__default__dark__input-text.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/content-add-article__default__dark__input-text.png
...
1. XPath: `//*[@id="edit-title-0-value"]`
   - Related element screenshot: candidate/content-add-article__default__dark__input-text.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/content-add-article__default__dark__input-text.png
