...
- Candidate element screenshot: candidate/theme-settings__contrast-and-descriptions__light__h2.png
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/theme-settings__contrast-and-descriptions__light__h2.png
...
1. XPath: `//*[@id="admin-toolbar__scroll-wrapper-1396374748"]`
   - Text sample: Administrative sidebar
   - Related element screenshot: candidate/theme-settings__contrast-and-descriptions__light__h2.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/theme-settings__contrast-and-descriptions__light__h2.png
...
```html
<h2 id="admin-toolbar__scroll-wrapper-1396374748" class="visually-hidden">Administrative sidebar</h2>
```
