# Admin Theme (dark + light) Structure Menus - Dropbutton Toggle Button style regression vs Drupal 11 Gin
...
## Color Mode Coverage
- light: fontSize: -12.5% | count: +2 (40.0%)
- dark: fontSize: -12.5% | count: +2 (40.0%)
