...
## Evidence
- Baseline element screenshot: baseline/structure-menu-admin__default__dark__required-marker.png
- Candidate element screenshot: candidate/structure-menu-admin__default__dark__required-marker.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menu-admin__default__dark__required-marker.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menu-admin__default__dark__required-marker.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/form[1]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: baseline/structure-menu-admin__default__dark__required-marker.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menu-admin__default__dark__required-marker.png
...
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/form[1]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: candidate/structure-menu-admin__default__dark__required-marker.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menu-admin__default__dark__required-marker.png
