# Admin Theme (light) Content - Dropbutton Secondary Action Link style regression vs Drupal 11 Gin

## Summary
Potential CSS regression in **Dropbutton Secondary Action Link** on **Content** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
Color mode: **light**
...
## Evidence
- Baseline element screenshot: baseline/content__light__dropbutton-secondary-action.png
- Candidate element screenshot: candidate/content__light__dropbutton-secondary-action.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/content__light__dropbutton-secondary-action.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/content__light__dropbutton-secondary-action.png
