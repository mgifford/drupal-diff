...
1. XPath: `//*[@id="admin-toolbar__scroll-wrapper-349167739"]`
   ...
   - Related element screenshot: candidate/config-text-format-basic-html__default__light__h2.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-text-format-basic-html__default__light__h2.png
