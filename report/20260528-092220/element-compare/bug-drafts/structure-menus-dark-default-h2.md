# Admin Theme (dark) Structure Menus - H2 Heading style regression vs Drupal 11 Gin
...
- Candidate element screenshot: candidate/structure-menus__default__dark__h2.png
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menus__default__dark__h2.png
...
1. XPath: `//*[@id="admin-toolbar__scroll-wrapper-2127595315"]`
   - Text sample: Administrative sidebar
   - Related element screenshot: candidate/structure-menus__default__dark__h2.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menus__default__dark__h2.png
...
```html
<h2 id="admin-toolbar__scroll-wrapper-2127595315" class="visually-hidden">Administrative sidebar</h2>
```
