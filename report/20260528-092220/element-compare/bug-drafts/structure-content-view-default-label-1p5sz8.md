# Admin Theme (dark + light) Structure Content View - Form Label style regression vs Drupal 11 Gin
...
## Evidence
- Baseline element screenshot: baseline/structure-view-content__default__light__label.png
- Candidate element screenshot: candidate/structure-view-content__default__light__label.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-view-content__default__light__label.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-view-content__default__light__label.png
...
### Drupal 11 with Gin
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/div[2]/form[1]/div[4]/div[2]/div[2]/div[1]/div[2]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: baseline/structure-view-content__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-view-content__default__light__label.png
...
```html
<label for="edit-title--DE6t9sg_avc" class="form-item__label">Title</label>
```
...
```html
<label for="edit-type--LCruAURW6Ks" class="form-item__label">Content type</label>
```

### Drupal 12 with Admin Theme
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/div[2]/form[1]/div[4]/div[2]/div[2]/div[1]/div[2]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: candidate/structure-view-content__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-view-content__default__light__label.png
...
```html
<label for="edit-title--itoPYijFwxM" class="form-item__label">Title</label>
```
...
```html
<label for="edit-type--dwKw38PHWPQ" class="form-item__label">Content type</label>
```
