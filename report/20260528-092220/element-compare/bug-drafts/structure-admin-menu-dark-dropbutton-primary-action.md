# Admin Theme (dark) Structure Admin Menu - Dropbutton Primary Action Link style regression vs Drupal 11 Gin
...
## Evidence
- Baseline element screenshot: baseline/structure-menu-admin__dark__dropbutton-primary-action.png
- Candidate element screenshot: candidate/structure-menu-admin__dark__dropbutton-primary-action.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menu-admin__dark__dropbutton-primary-action.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menu-admin__dark__dropbutton-primary-action.png
