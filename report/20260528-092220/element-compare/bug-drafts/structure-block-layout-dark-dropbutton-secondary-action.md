# Admin Theme (dark) Structure Block Layout - Dropbutton Secondary Action Link style regression vs Drupal 11 Gin
...
```html
<a href="/admin/structure/block/manage/olivero_site_branding/disable?destination=/admin/structure/block&amp;token=JqRdxWYBWVHHN-Uedlm1M44vwKna74Jd9J3AThnPbio">Disable</a>
```
...
```html
<a href="/admin/structure/block/manage/olivero_site_branding/disable?destination=/admin/structure/block&amp;token=Zky1sn6LmmEkTwQC5LnUYMvO97OIhZAn1hKzfkTF3_E">Disable</a>
```
