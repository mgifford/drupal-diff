...
## Evidence
- Baseline element screenshot: baseline/config-text-formats__dark__dropbutton-toggle.png
- Candidate element screenshot: candidate/config-text-formats__dark__dropbutton-toggle.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/config-text-formats__dark__dropbutton-toggle.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-text-formats__dark__dropbutton-toggle.png
