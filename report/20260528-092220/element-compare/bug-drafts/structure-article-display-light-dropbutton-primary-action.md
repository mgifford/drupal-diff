# Admin Theme (light) Structure Article Display - Dropbutton Primary Action Link style regression vs Drupal 11 Gin
...
- Candidate element screenshot: candidate/structure-content-type-article-display__light__dropbutton-primary-action.png

- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-content-type-article-display__light__dropbutton-primary-action.png
...
```html
<a href="/admin/structure/types/manage/article/display/full/enable?token=xB-LpCWky2I3wvPofOCQCAHDkRqYKYycpVGfR0oYvn4">Enable <span class="visually-hidden">(Full content)</span></a>
```
