...
## Evidence
- Baseline element screenshot: baseline/config-performance__default__dark__label.png
- Candidate element screenshot: candidate/config-performance__default__dark__label.png
- Baseline page screenshot: baseline-pages/config-performance__default__dark__page.png
- Candidate page screenshot: candidate-pages/config-performance__default__dark__page.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/config-performance__default__dark__label.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-performance__default__dark__label.png
- Baseline page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline-pages/config-performance__default__dark__page.png
- Candidate page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate-pages/config-performance__default__dark__page.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/form[2]/details[1]/div[1]/div[1]/label[1]`
   ...
   - Related element screenshot: baseline/config-performance__default__dark__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/config-performance__default__dark__label.png
   - Related page screenshot: baseline-pages/config-performance__default__dark__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline-pages/config-performance__default__dark__page.png
...
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/form[2]/details[1]/div[1]/div[1]/label[1]`
   - Text sample: Browser and proxy cache maximum age
   - Related element screenshot: candidate/config-performance__default__dark__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-performance__default__dark__label.png
   - Related page screenshot: candidate-pages/config-performance__default__dark__page.png
