# Admin Theme (dark + light) People List - Toolbar Structure Toggle Button style regression vs Drupal 11 Gin
...
## Summary
Potential CSS regression in **Toolbar Structure Toggle Button** on **People List** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
...
## Evidence
- Baseline element screenshot: baseline/people-list__default__light__toolbar-structure-toggle.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/people-list__default__light__toolbar-structure-toggle.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[4]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/people-list__default__light__toolbar-structure-toggle.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/people-list__default__light__toolbar-structure-toggle.png
