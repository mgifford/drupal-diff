# Admin Theme (dark + light) Structure Overview - Button style regression vs Drupal 11 Gin
...
## Summary
Potential CSS regression in **Button** on **Structure Overview** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
...
2. Open candidate page: http://drupal-12-git.ddev.site:8080/admin/structure
...
## Evidence
- Baseline element screenshot: baseline/structure-overview__default__light__button.png
- Candidate element screenshot: candidate/structure-overview__default__light__button.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-overview__default__light__button.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-overview__default__light__button.png
- Baseline page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline-pages/structure-overview__default__light__page.png
- Candidate page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate-pages/structure-overview__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[2]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/structure-overview__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-overview__default__light__button.png
   - Related page screenshot: baseline-pages/structure-overview__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline-pages/structure-overview__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[1]/div[2]/ul[1]/li[1]/button[1]`
   - Text sample: Extend Create
   - Related element screenshot: candidate/structure-overview__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-overview__default__light__button.png
   - Related page screenshot: candidate-pages/structure-overview__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate-pages/structure-overview__default__light__page.png
