# Admin Theme (light) People Roles - H2 Heading style regression vs Drupal 11 Gin

## Summary
Potential CSS regression in **H2 Heading** on **People Roles** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
Color mode: **light**
...
- Candidate element screenshot: candidate/people-roles__default__light__h2.png
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/people-roles__default__light__h2.png
...
1. XPath: `//*[@id="admin-toolbar__scroll-wrapper-1166683920"]`
   ...
   - Related element screenshot: candidate/people-roles__default__light__h2.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/people-roles__default__light__h2.png
