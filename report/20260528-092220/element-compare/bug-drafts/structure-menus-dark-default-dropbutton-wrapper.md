# Admin Theme (dark) Structure Menus - Dropbutton Wrapper style regression vs Drupal 11 Gin
...
## Evidence
- Baseline element screenshot: baseline/structure-menus__default__dark__dropbutton-wrapper.png
- Candidate element screenshot: candidate/structure-menus__default__dark__dropbutton-wrapper.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menus__default__dark__dropbutton-wrapper.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menus__default__dark__dropbutton-wrapper.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]`
   ...
   - Related element screenshot: baseline/structure-menus__default__dark__dropbutton-wrapper.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menus__default__dark__dropbutton-wrapper.png
...
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]`
   - Text sample: Edit menuList additional actions Add link
   - Related element screenshot: candidate/structure-menus__default__dark__dropbutton-wrapper.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menus__default__dark__dropbutton-wrapper.png
