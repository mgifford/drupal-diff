...
- Vertical padding is significantly higher: 16.0px vs 8.0px (+100.0%).
- Horizontal padding is significantly higher: 24.0px vs 17.6px (+36.2%).
...
- Candidate element screenshot: candidate/reports-status__default__light__h2.png
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/reports-status__default__light__h2.png
