# Admin Theme (dark) Content Overview - Form Label style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Component width is noticeably wider: 83.0px vs 62.1px (+33.6%).
- Component height is significantly shorter: 7.4px vs 40.5px (-81.8%).
...
## Evidence
- Baseline element screenshot: baseline/content-overview__default__dark__label.png
- Candidate element screenshot: candidate/content-overview__default__dark__label.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/content-overview__default__dark__label.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/content-overview__default__dark__label.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: baseline/content-overview__default__dark__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/content-overview__default__dark__label.png
...
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: candidate/content-overview__default__dark__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/content-overview__default__dark__label.png
