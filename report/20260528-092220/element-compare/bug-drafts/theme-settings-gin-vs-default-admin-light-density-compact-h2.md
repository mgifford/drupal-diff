...
1. XPath: `//*[@id="admin-toolbar__scroll-wrapper-1031697887"]`
   - Text sample: Administrative sidebar
   - Related element screenshot: candidate/theme-settings__density-compact__light__h2.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/theme-settings__density-compact__light__h2.png
...
```html
<h2 id="admin-toolbar__scroll-wrapper-1031697887" class="visually-hidden">Administrative sidebar</h2>
```
