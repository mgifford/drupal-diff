# Admin Theme (dark + light) Configuration Text Formats - Button style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Component width is noticeably wider: 225.8px vs 189.7px (+19.0%).
...
## Summary
Potential CSS regression in **Button** on **Configuration Text Formats** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
Color mode coverage: **dark + light**

## Color Mode Coverage
- light: lineHeight: -9.9% | paddingY: 42.9% | paddingX: 52.8% | width: 19.0% | height: 14.3%
- dark: lineHeight: -9.9% | paddingY: 42.9% | paddingX: 52.8% | width: 19.0% | height: 14.3%
...
## Likely CSS Sources
- http://drupal-git.ddev.site:8080/sites/default/files/css/css_Y2fRQNI2W3fWuksN_OOjRA2OMGffpy-g_o_oDh3cVWc.css
...
## Evidence
- Baseline element screenshot: baseline/config-text-formats__default__light__button.png
- Candidate element screenshot: candidate/config-text-formats__default__light__button.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/config-text-formats__default__light__button.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-text-formats__default__light__button.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[2]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/config-text-formats__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/config-text-formats__default__light__button.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[1]/div[2]/ul[1]/li[1]/button[1]`
   - Text sample: Extend Create
   - Related element screenshot: candidate/config-text-formats__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-text-formats__default__light__button.png
