# Admin Theme (light) Structure Menus - Dropbutton Toggle Button style regression vs Drupal 11 Gin
...
## Evidence
- Baseline element screenshot: baseline/structure-menus__default__light__dropbutton-toggle.png
- Candidate element screenshot: candidate/structure-menus__default__light__dropbutton-toggle.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menus__default__light__dropbutton-toggle.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menus__default__light__dropbutton-toggle.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]/div[1]/ul[1]/li[2]/button[1]`
   ...
   - Related element screenshot: baseline/structure-menus__default__light__dropbutton-toggle.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menus__default__light__dropbutton-toggle.png
...
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]/div[1]/ul[1]/li[2]/button[1]`
   - Text sample: List additional actions
   - Related element screenshot: candidate/structure-menus__default__light__dropbutton-toggle.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menus__default__light__dropbutton-toggle.png
