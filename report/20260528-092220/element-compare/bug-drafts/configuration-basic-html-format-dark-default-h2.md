# Admin Theme (dark) Configuration Basic HTML Format - H2 Heading style regression vs Drupal 11 Gin
...
- Candidate element screenshot: candidate/config-text-format-basic-html__default__dark__h2.png
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-text-format-basic-html__default__dark__h2.png
...
1. XPath: `//*[@id="admin-toolbar__scroll-wrapper-349167739"]`
   ...
   - Related element screenshot: candidate/config-text-format-basic-html__default__dark__h2.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/config-text-format-basic-html__default__dark__h2.png
