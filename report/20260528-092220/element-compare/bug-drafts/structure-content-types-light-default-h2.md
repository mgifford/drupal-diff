# Admin Theme (light) Structure Content Types - H2 Heading style regression vs Drupal 11 Gin
...
- Candidate element screenshot: candidate/structure-content-types__default__light__h2.png
...
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-content-types__default__light__h2.png
...
1. XPath: `//*[@id="admin-toolbar__scroll-wrapper-141446457"]`
   - Text sample: Administrative sidebar
   - Related element screenshot: candidate/structure-content-types__default__light__h2.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-content-types__default__light__h2.png
...
```html
<h2 id="admin-toolbar__scroll-wrapper-141446457" class="visually-hidden">Administrative sidebar</h2>
```
