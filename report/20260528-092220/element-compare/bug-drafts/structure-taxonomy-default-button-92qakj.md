# Admin Theme (dark + light) Structure Taxonomy - Button style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Component width is noticeably wider: 225.8px vs 196.4px (+14.9%).
...
## Summary
Potential CSS regression in **Button** on **Structure Taxonomy** when comparing Drupal 11 with Gin to Drupal 12 with Admin Theme.
Color mode coverage: **dark + light**

## Color Mode Coverage
- light: lineHeight: -5.1% | paddingY: 25.0% | paddingX: 33.7% | width: 14.9% | height: 10.2%
- dark: lineHeight: -5.1% | paddingY: 25.0% | paddingX: 33.7% | width: 14.9% | height: 10.2%

## Steps To Reproduce
1. Open baseline page: http://drupal-11.3.10.ddev.site/admin/structure/taxonomy
2. Open candidate page: http://drupal-12-git.ddev.site:8080/admin/structure/taxonomy
...
## Evidence
- Baseline element screenshot: baseline/structure-taxonomy__default__light__button.png
- Candidate element screenshot: candidate/structure-taxonomy__default__light__button.png
- Baseline page screenshot: baseline-pages/structure-taxonomy__default__light__page.png
- Candidate page screenshot: candidate-pages/structure-taxonomy__default__light__page.png
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-taxonomy__default__light__button.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-taxonomy__default__light__button.png
- Baseline page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline-pages/structure-taxonomy__default__light__page.png
- Candidate page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate-pages/structure-taxonomy__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[2]/ul[1]/li[1]/button[1]`
   ...
   - Related element screenshot: baseline/structure-taxonomy__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-taxonomy__default__light__button.png
   - Related page screenshot: baseline-pages/structure-taxonomy__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline-pages/structure-taxonomy__default__light__page.png
...
1. XPath: `/html[1]/body[1]/aside[1]/nav[1]/div[1]/div[2]/ul[1]/li[1]/button[1]`
   - Text sample: Extend Create
   - Related element screenshot: candidate/structure-taxonomy__default__light__button.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-taxonomy__default__light__button.png
   - Related page screenshot: candidate-pages/structure-taxonomy__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate-pages/structure-taxonomy__default__light__page.png
