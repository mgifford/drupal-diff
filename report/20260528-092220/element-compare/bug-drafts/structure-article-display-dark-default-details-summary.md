# Admin Theme (dark) Structure Article Display - Details Summary style regression vs Drupal 11 Gin
...
- Vertical padding is significantly (less): 0.0px vs 40.0px (-100.0%).
- Horizontal padding is significantly (less): 0.0px vs 60.0px (-100.0%).
...
## Evidence
- Baseline element screenshot: baseline/structure-content-type-article-display__default__dark__details-summary.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-content-type-article-display__default__dark__details-summary.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/form[1]/details[1]/summary[1]`
   ...
   - Related element screenshot: baseline/structure-content-type-article-display__default__dark__details-summary.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-content-type-article-display__default__dark__details-summary.png
