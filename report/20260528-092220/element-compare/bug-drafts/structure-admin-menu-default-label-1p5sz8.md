# Admin Theme (dark + light) Structure Admin Menu - Form Label style regression vs Drupal 11 Gin

## Human-Readable Change Summary
- Component width is significantly wider: 1047.0px vs 76.1px (+1274.9%).
- Component height is significantly shorter: 18.0px vs 58.5px (-69.2%).
...
## Color Mode Coverage
- light: width: 1274.9% | height: -69.2% | count: -6 (-75.0%)
- dark: width: 1274.9% | height: -69.2% | count: -6 (-75.0%)
...
## Evidence
- Baseline element screenshot: baseline/structure-menu-admin__default__light__label.png
- Candidate element screenshot: candidate/structure-menu-admin__default__light__label.png
...
- Baseline element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menu-admin__default__light__label.png
- Candidate element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menu-admin__default__light__label.png
...
1. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/form[1]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: baseline/structure-menu-admin__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menu-admin__default__light__label.png
...
2. XPath: `/html[1]/body[1]/div[2]/div[5]/main[1]/div[4]/div[1]/form[1]/div[3]/label[1]`
   - Text sample: Administrative summary
   - Related element screenshot: baseline/structure-menu-admin__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline/structure-menu-admin__default__light__label.png
   - Related page screenshot: baseline-pages/structure-menu-admin__default__light__page.png
   - Related page screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/baseline-pages/structure-menu-admin__default__light__page.png
...
```html
<label for="edit-description" class="form-item__label">Administrative summary</label>
```

### Drupal 12 with Admin Theme
1. XPath: `/html[1]/body[1]/div[4]/div[2]/main[1]/div[4]/div[1]/form[1]/div[1]/label[1]`
   - Text sample: Title
   - Related element screenshot: candidate/structure-menu-admin__default__light__label.png
   - Related element screenshot (GitHub): https://github.com/mgifford/drupal-diff/blob/main/report/20260528-092220/element-compare/candidate/structure-menu-admin__default__light__label.png
