...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  46827 pixels (ratio 0.05 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e244]:
    - banner [ref=e245]:
      - heading "Available updates" [level=1] [ref=e249]
    - generic [ref=e253]:
        ...
        - list [ref=e256]:
          - listitem [ref=e257]:
            - link "List" [ref=e258] [cursor=pointer]:
              - /url: /admin/reports/updates
          - listitem [ref=e259]:
            - link "Settings" [ref=e260] [cursor=pointer]:
              - /url: /admin/reports/updates/settings
    - main [ref=e262]:
      - complementary [ref=e266]:
        - paragraph [ref=e267]: Here you can find information about available updates for your installed modules and themes. Note that each module or theme is part of a "project", which may or may not have the same name, and might include multiple modules or themes within it.
      - generic [ref=e269]:
        - paragraph [ref=e270]:
          - text: "Last checked: 2 minutes 57 seconds ago ("
          - link "Check manually" [ref=e271] [cursor=pointer]:
            - /url: /admin/reports/updates/check?destination=/admin/reports/updates&token=JTSPnS94V3I4tEcy-BXQOUbAHOg5nCRfAmXQuMQ_wpc
          - text: )
        - heading "Drupal core" [level=3] [ref=e272]
        - table [ref=e274]:
          - rowgroup [ref=e275]:
            - row [ref=e276]:
              - cell [ref=e277]:
                - generic [ref=e280]: Not supported!
                - generic [ref=e281]:
                  - link "Drupal core" [ref=e282] [cursor=pointer]:
