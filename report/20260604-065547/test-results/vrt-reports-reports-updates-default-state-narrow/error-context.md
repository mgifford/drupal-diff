...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  35355 pixels (ratio 0.12 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e18]:
    ...
    - main [ref=e37]:
      ...
      - generic [ref=e44]:
        - paragraph [ref=e45]:
          - text: "Last checked: 14 seconds ago ("
          - link "Check manually" [ref=e46] [cursor=pointer]:
            - /url: /admin/reports/updates/check?destination=/admin/reports/updates&token=skVmGRPbBSsw-WlUpXi_KflnBMh5LWzs6p-1oPEREyA
          - text: )
